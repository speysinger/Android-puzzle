...
Rectangle {
    ...
    Row {
        ...
        Rectangle {
            ...
            Text{
                ...
                text: "Вопрос"
                font{
                    pointSize: Math.min(_questionTitle.width===0?1:_questionTitle.width,
                                        _questionTitle.height===0?1:_questionTitle.height)/3
                    bold:true
                }
            }
        }
        Rectangle{
            ...
            Text{
                ...
                text: "Ответ"
                font{
                    pointSize: Math.min(_answersTitle.width===0?1:_answersTitle.width,
                                        _answersTitle.height===0?1:_answersTitle.height)/3
                    bold:true
                }
            }
        }
    ...
    Button {
        ...
        Text{
            ...
            font{
                pointSize: Math.min((_backToTestSettingsWindow.height===0?1:_backToTestSettingsWindow.height)
                                    ,(_backToTestSettingsWindow.width===0?1:_backToTestSettingsWindow.width))/2
            }
        }
