...
struct EraListModelItem
{
  ...
  EraListModelItem(QString eraName_, int domesticFilesCount_, int internationalFilesCount_, bool eraNeedToUpdate_,
                   bool checkValue_, bool domesticSelected_, bool internationalSelected_)
    : eraName(eraName_)
...
struct StatisticRecord
{
  ...
  StatisticRecord(QString eraName_, QString artName_, QString worstTime_, QString bestTime_, QString mode_)
    : eraName(eraName_), artName(artName_), worstTime(worstTime_), bestTime(bestTime_), mode(mode_)
  {
  }
};
